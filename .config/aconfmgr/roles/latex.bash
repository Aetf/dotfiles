AddPackage ttf-times-new-roman # Times New Roman font from Microsoft

# bibtex-tidy has permission error in /usr/bin in its package
#AddPackage bibtex-tidy # BibTeX Tidy - Cleaner and Formatter for BibTeX files
